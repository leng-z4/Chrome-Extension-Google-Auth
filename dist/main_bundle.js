...
function startAuth(interactive) {
    chrome.identity.getAuthToken({ interactive: !!interactive }, function (token) {
        if (chrome.runtime.lastError && !interactive) {
            ...
            var credential = firebase_auth__WEBPACK_IMPORTED_MODULE_1__.GoogleAuthProvider.credential(token);
            ...
            (0,firebase_auth__WEBPACK_IMPORTED_MODULE_1__.signInWithCredential)(credential)
            .then(result => {
                console.log(result);
            }).catch(error => {
                console.log(error);
